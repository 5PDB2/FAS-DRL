"""
Step 1: Generate channel datasets for multiple correlation factors (dataset variant).

Saves a dict mapping rho -> list of complex channel matrices to
experiments_dataset/data/channels_dataset.pkl
"""
